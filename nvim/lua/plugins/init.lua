return {
	...
	-- Render markdown
	{
		...
		opts = {
			-- Basic configuration goes here (or leave empty for defaults)
			enabled = true,
			file_types = { "markdown" },
		},
	},
	...
	-- ToggleTerminal
	{
		...
		config = function()
			require("toggleterm").setup({
				...
				shell = [[C:\Users\idang\AppData\Local\Microsoft\WindowsApps\Microsoft.PowerShell_8wekyb3d8bbwe\pwsh.exe]],
				float_opts = {
